...
const CapabilitiesPage = () => {
  return (
    <div className="max-w-7xl mx-auto text-center p-6 sm:p-8 lg:p-10">
      <div>
        <Breadcrumbs />
        <h1 className="text-4xl font-bold text-slate-900 mb-4">Technical Components</h1>
        <p className="text-lg text-slate-600 mb-8">A high-level overview of the agent's technical capabilities.</p>
      </div>
      ...
      <div className="flex items-center justify-center">
        <div className="bg-white p-8 rounded-xl shadow-lg border border-slate-200 min-h-[400px] w-full flex items-center justify-center">
            <div className="text-center">
                <h3 className="mt-2 text-sm font-medium text-slate-900">Technical Components Coming Soon</h3>
                <p className="mt-1 text-sm text-slate-500">Check back later for detailed technical components.</p>
            </div>
        </div>
      </div>
      ...
      <div className="mt-12 text-center">
        <Link
          to="/requirement-gathering-agent/architecture"
