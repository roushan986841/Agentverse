...
const FlowPlannerArchitecturePage = () => {
  return (
    <div className="max-w-7xl mx-auto text-center p-6 sm:p-8 lg:p-10">
      <div>
        <Breadcrumbs />
        <h1 className="text-4xl font-bold text-slate-900 mb-4">Flow Planner Agent Architecture</h1>
      ...
      <div className="mt-12 text-center">
        <Link
          to="/flow-planner-agent/agent-list"
...
export default FlowPlannerArchitecturePage;
