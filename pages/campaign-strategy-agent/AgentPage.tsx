  ...
  return (
    <div className="max-w-6xl mx-auto text-slate-700 p-6 sm:p-8 lg:p-10 animate-fade-in">
        ...
        <div className="space-y-10">
           <div className="grid lg:grid-cols-5 gap-8 items-center">
                  ...
                  <Card className="h-full">
                    <div className="p-8">
                      ...
                      <p className="text-lg text-slate-600 leading-relaxed">
                        Synthesizes objectives, insights, and channel considerations into actionable strategy drafts. Designed for Brand Strategists and Campaign Leads to quickly formulate data-driven strategies for upcoming marketing campaigns.
                      </p>
                    </div>
                  </Card>
               </div>
               <div className="lg:col-span-2 flex justify-center p-4">
                  <img 
                      src="/CampaignStrategy.png" 
                      alt="Campaign Strategy Agent Illustration" 
              ...
              <Card>
                  <div className="p-8">
                    ...
                    <ul className="space-y-3">
                        <BulletPoint>Strategy drafts</BulletPoint>
                        <BulletPoint>Objective-execution mapping</BulletPoint>
                        <BulletPoint>Channel alignment</BulletPoint>
                        <BulletPoint>Recommendations</BulletPoint>
                        <BulletPoint>AI-generated strategic scenarios</BulletPoint>
                        <BulletPoint>Budget-aware strategy simulation</BulletPoint>
                    </ul>
                  </div>
              </Card>
          </div>
      ...
      <div className="text-center pt-8">
        <Link
          to="/campaign-strategy-agent/technical-components"
