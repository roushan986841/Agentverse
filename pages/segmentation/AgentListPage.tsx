...
import { SEGMENTATION_AGENTS_LIST } from '../../constants.tsx';
            ...
            <div className="max-w-7xl mx-auto p-6 sm:p-8 lg:p-10 animate-fade-in">
                <div>
                    ...
                    <header className="text-center mb-10">
                        <h1 className="text-4xl md:text-5xl font-extrabold text-[#002D72]">Active Segmentation Agents</h1>
                        <p className="mt-4 text-lg text-slate-600 max-w-3xl mx-auto">Manage your deployed segmentation agents. View their configuration details or run a demo.</p>
                    </header>
                </div>
              
              <div>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                    {SEGMENTATION_AGENTS_LIST.map(agent => (
