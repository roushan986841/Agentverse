...
import { FLOW_PLANNER_AGENTS_LIST } from '../../constants.tsx';
...
const FlowPlannerAgentListPage = () => {
            ...
            <div className="max-w-7xl mx-auto p-6 sm:p-8 lg:p-10">
                <div>
                    ...
                    <header className="text-center mb-10">
                        <h1 className="text-4xl md:text-5xl font-extrabold text-[#002D72]">Active Flow Planner Agents</h1>
                        <p className="mt-4 text-lg text-slate-600 max-w-3xl mx-auto">Manage your deployed flow planning agents. View their configuration details or run a demo.</p>
                    </header>
                </div>
              
              <div>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                    {FLOW_PLANNER_AGENTS_LIST.map(agent => (
...
export default FlowPlannerAgentListPage;
