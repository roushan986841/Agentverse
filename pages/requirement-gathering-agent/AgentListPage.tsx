...
import { REQUIREMENT_GATHERING_AGENTS_LIST } from '../../constants.tsx';

const AgentListPage = () => {
  return (
    <div className="max-w-7xl mx-auto p-6 sm:p-8 lg:p-10">
      <Breadcrumbs />
      <h1 className="text-4xl font-bold text-slate-900 mb-8">Requirement Gathering Agent List</h1>
      <div className="grid gap-6">
        {REQUIREMENT_GATHERING_AGENTS_LIST.map((agent) => (
