  ...
  return (
    <div className="max-w-6xl mx-auto text-slate-700 p-6 sm:p-8 lg:p-10 animate-fade-in">
        ...
        <div className="space-y-10">
           <div className="grid lg:grid-cols-5 gap-8 items-center">
                  ...
                  <Card className="h-full">
                    <div className="p-8">
                      ...
                      <p className="text-lg text-slate-600 leading-relaxed">
                        Segregates email audiences based on domain, engagement, and compliance needs. Designed for Marketing Ops and CRM Teams to optimize deliverability and ensure compliance.
                      </p>
                    </div>
                  </Card>
               </div>
               <div className="lg:col-span-2 flex justify-center p-4">
                  <img 
                      src="/EmailSegregator.png" 
                      alt="Email Segregator Agent Illustration" 
              ...
              <Card>
                  <div className="p-8">
                    ...
                    <ul className="space-y-3">
                        <BulletPoint>Automated email segregation</BulletPoint>
                        <BulletPoint>Compliance-safe grouping</BulletPoint>
                        <BulletPoint>Adaptive segregation rules</BulletPoint>
                        <BulletPoint>Deliverability optimization</BulletPoint>
                    </ul>
                  </div>
              </Card>
          </div>
      ...
      <div className="text-center pt-8">
        <Link
          to="/email-segregator-agent/technical-components"
