...
const ImagePlaceholder = ({className = ''}) => (
    <div className={`flex items-center justify-center ${className}`}>
        <img 
            src="/Camellia.png" 
            alt="Camellia Agent Illustration" 
  ...
  return (
    <div className="max-w-6xl mx-auto text-slate-700 p-6 sm:p-8 lg:p-10 animate-fade-in">
      <div>
        ...
        <header className="mb-12 text-center">
          <h1 className="text-4xl md:text-5xl font-extrabold text-slate-900 leading-tight">
            Build Salesforce Automations at the Speed of Thought with the <span className="text-[#002D72]">Camellia Agent</span>
          </h1>
        </header>
      </div>
      ...
      <div className="text-center pt-8">
        <Link
          to="/camellia-agent/technical-components"
